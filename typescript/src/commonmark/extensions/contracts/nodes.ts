...
export type { MarkData } from './MarkData.js';
export type { BlockMathData } from './BlockMathData.js';
export type { InlineMathData } from './InlineMathData.js';
export type { StrikethroughData } from './StrikethroughData.js';
export type { CellData } from './CellData.js';
export type { Alignment } from './Alignment.js';
export type { RowData } from './RowData.js';
