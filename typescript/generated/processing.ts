 ...
 */
origin: string, };
export type ProcessOutput = { notificationText: string, plainText: string, attachments: Array<string>, citations: Array<string>, references: References, embedding: EmbeddingPlan, };
