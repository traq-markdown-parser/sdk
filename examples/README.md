...
Rust uses the local `markdown-traq` grammar crate; extension implementations resolve from pinned Git dependencies. Go uses a local `replace` for this repository's module. TypeScript imports this package's public exports. No registry publication or application checkout is required.
...
HTML rendering examples live in [traq-markdown-it](https://github.com/traPtitech/traq-markdown-it). Native notification and extraction examples live in [this repository](../crates/traq-processing/examples).
